...
\noindent {\bf Average case running time of SRA:} As mentioned in section~\ref{sec:arm-sra}, 
resultants defined in relation~\eqref{original_resultant} have the same degree as $f$. 
As the polynomials $f^{(i)}$ computed in step \ref{alg:sra:sqfree} are only the 
