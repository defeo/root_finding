...
\noindent {\bf Average case running time of SRA:} The number of iterations of the SRA is highly related to the length of the shortest path $h'_d$ (starting from the root)
