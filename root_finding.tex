...
\noindent {\bf Average case running time of SRA:} According to ARM algorithm, the number of iterations $h$ is the smallest value for which $\deg f^{(h)}=\qq^{n-h}$. Its means that $h$ is the 
